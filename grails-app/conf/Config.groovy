...
grails.plugin.springsecurity.auth.afterLogoutUrl = '/areaRestrita/logout'
grails.plugin.springsecurity.successHandler.defaultTargetUrl = '/controle_viagens'
...
//grails.plugin.springsecurity.interceptUrlMap = [
//	'/**':			['ROLE_ADMIN'],
//	'/areaRestrita/logar':	['IS_AUTHENTICATED_ANONYMOUSLY'],
